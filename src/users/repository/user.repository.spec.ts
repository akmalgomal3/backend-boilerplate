...
describe('UserRepository', () => {
    ...
    describe('getUsers', () => {
        it('should return users array and count', async () => {
            ...
            (mockRepository.findAndCount as jest.Mock).mockResolvedValue([mockUsers, mockCount]);
    ...
    describe('getUserById', () => {
        ...
        it('should throw error when user not found', async () => {
            ...
            await expect(userRepository.getUserById('1')).rejects.toThrow('User not found');
        });
